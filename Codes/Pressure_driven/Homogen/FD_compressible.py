...
save_itr = 2
T = 10*24*3600           # final time
num_steps = 100*save_itr    # number of time steps
...
Cr = Constant(9e-10) # This value should be taken (3~9e-10 PSI^-1) physical rng:4.35e-10 to 8.7e-10 %But here I took range (3e-10 to 9e-10)
Cw = Constant(1e-10)
Cl = Constant(1e-6)
...
file_p = File("./Output/Rock_compressible/pres+FL+SL_Cr9.pvd")
file_s = File("./Output/Rock_compressible/sat+FL+SL_Cr9.pvd")
