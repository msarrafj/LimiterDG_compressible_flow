...
domain_length = 1000.
nx = 50
layer = '73' # layer 13 and layer 73
...
#
# Heterogen K
# k_subdomain = conditional(And(And(x[0]>400,x[0]<600),And(x[1]>400,x[1]<600)),1e-13,1e-12)
